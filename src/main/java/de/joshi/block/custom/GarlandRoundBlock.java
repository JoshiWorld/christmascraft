...
public class GarlandRoundBlock extends HorizontalConnectingBlock { // HorizontalDirectionalBlock
    public GarlandRoundBlock() {
        super(1.0f, 1.0f, 16.0f, 16.0f, 16.0f, FabricBlockSettings.copyOf(Blocks.SPRUCE_LEAVES));
