...
public class ModSounds {
    ...
    public static final SoundEvent MARRYCHRISTMAS = registerSoundEvent("marrychristmas");
    public static final SoundEvent JINGLEBELLS = registerSoundEvent("jinglebells");
    ...
    private static SoundEvent registerSoundEvent(String name) {
        Identifier id = new Identifier(ChristmasCraft.MOD_ID, name);
        return Registry.register(Registries.SOUND_EVENT, id, SoundEvent.of(id));
    }

    public static void registerSounds() {
        ChristmasCraft.LOGGER.info("Registering Mod Sounds for " + ChristmasCraft.MOD_ID);
    }
}
